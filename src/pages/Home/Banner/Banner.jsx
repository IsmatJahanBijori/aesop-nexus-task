    ...
    return (
        ...
        <div class="relative ">
            ...
            <div className='flex flex-col md:flex-row md:justify-between'>
                ...
                <div className="absolute top-20 bottom-0 mb-60 md:mb-0 left-0 mt-[90px] md:mt-0 md:ml-80 px-4 py-2 w-full h-[300px] md:w-[700px] bg-black bg-opacity-30 md:bg-transparent">
